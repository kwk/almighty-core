...
// A SetupFunc ... TODO(kwk): document me
type SetupFunc func(ctx *TestContext)
...
// NewContext will create a test context by executing the recipies from the given
// setup creation functions. If setupFuncs is empty, nothing will happen. If
...
// comment.
func NewContext(t *testing.T, db *gorm.DB, setupFuncs ...SetupFunc) *TestContext {
	return newContext(t, db, false, setupFuncs...)
}

// NewContextIsolated will create a test context by executing the recipies from the given
// setup creation functions. If setupFuncs is empty, nothing will happen. If
// there's an error during the setup, the given test t will fail.
//
// The difference to the normal NewContext function is that we will only create those
// object that where specified in the setupFuncs. We will not create any object
// that is normally demanded by an object. For example, if you call
...
//     }))
func NewContextIsolated(t *testing.T, db *gorm.DB, setupFuncs ...SetupFunc) *TestContext {
...
// is totally optional.
func Identities(n int, fns ...DeferredCreationFunc) SetupFunc {
	return SetupFunc(func(ctx *TestContext) {
...
func Spaces(n int, fns ...DeferredCreationFunc) SetupFunc {
	return SetupFunc(func(ctx *TestContext) {
...
//     Spaces(1)
// but with NewContextIsolated(), no other objects will be created.
func Iterations(n int, fns ...DeferredCreationFunc) SetupFunc {
	return SetupFunc(func(ctx *TestContext) {
...
//     Spaces(1)
// but with NewContextIsolated(), no other objects will be created.
func Areas(n int, fns ...DeferredCreationFunc) SetupFunc {
	return SetupFunc(func(ctx *TestContext) {
...
//     Spaces(1)
// but with NewContextIsolated(), no other objects will be created.
func Codebases(n int, fns ...DeferredCreationFunc) SetupFunc {
	return SetupFunc(func(ctx *TestContext) {
...
// will have no effect.
func WorkItems(n int, fns ...DeferredCreationFunc) SetupFunc {
	return SetupFunc(func(ctx *TestContext) {
...
//     WorkItems(1)
// but with NewContextIsolated(), no other objects will be created.
func Comments(n int, fns ...DeferredCreationFunc) SetupFunc {
	return SetupFunc(func(ctx *TestContext) {
...
func WorkItemTypes(n int, fns ...DeferredCreationFunc) SetupFunc {
	return SetupFunc(func(ctx *TestContext) {
...
func WorkItemLinkTypes(n int, fns ...DeferredCreationFunc) SetupFunc {
	return SetupFunc(func(ctx *TestContext) {
...
func WorkItemLinkCategories(n int, fns ...DeferredCreationFunc) SetupFunc {
	return SetupFunc(func(ctx *TestContext) {
...
// same work item.
func WorkItemLinks(n int, fns ...DeferredCreationFunc) SetupFunc {
	return SetupFunc(func(ctx *TestContext) {
...
func newContext(t *testing.T, db *gorm.DB, isolatedCreation bool, setupFuncs ...SetupFunc) *TestContext {
	ctx := TestContext{
		T:                t,
		info:             map[kind]*createInfo{},
		db:               db,
