...
[source,json]
----
include::examples/linkcategories-create-request.txt[]
----
...
[source,json]
----
include::examples/linkcategories-create-response.txt[]
----
...
[source,json]
----
include::examples/linkcategories-update-request.txt[]
----

More information on updating a resource and not including all attributes, 
...
[source,json]
----
include::examples/linkcategories-delete-request.txt[]
----
